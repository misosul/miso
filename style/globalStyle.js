...
const posth1Style = `text-4xl font-black`;
const posth2Style = `text-3xl font-black`;
const posth3Style = `text-2xl font-black`;
const posth4Style = `text-xl font-bold`;
const posth5Style = `text-lg font-bold`;
const posth6Style = `text-sm mb-2 -mt-4`;

const postpStyle = `font-normal tracking-wide`;
const postimgStyle = `w-full mx-auto block max-w-full h-auto align-middle`;
const postaStyle = `text-primary underline hover:bg-activation transition duration-200`;

const postulStyle = `list-disc list-inside font-normal tracking-wide text-justify`;
const postolStyle = `list-decimal list-inside font-normal tracking-wide text-justify`;
...
const posttableStyle = `table-auto w-auto mb-6 h-auto align-middle text-left`;
const posttheadStyle = `text-left`;
const postthStyle = `overflow-auto border-graylv2 px-4 py-2.5 font-medium text-sm capitalize whitespace-nowrap`;
...
const postemStyle = `font-medium italic pr-0.5`;
const poststrongStyle = `font-bold`;
...
const postauthorImgStyle = `inline w-8 h-8 rounded-full object-cover object-center mr-2 overflow-hidden`;
